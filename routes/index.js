...
exports.vitals = function(req, res) {
	//  ./vitals?height=20&weight=20&bpm=20&temp=20
	...
	// var temp = (92.8-89.7)*Math.random()+89.7;// body temp(89.7 - 92.8) 
...
exports.allVitals = function(req, res) {
	console.log("all vitals data retrieved");

	vitalQuery = vitalModel.find({}); // query for all sms
	// vitalQuery.select('sender message lastupdated');
	
	vitalQuery.exec(function(err, allVitals){
